...
if ($user->is_logged() && $user->is_admin()):
    ...
    <div class=" overflow-y-scroll h-full w-5/6 mx-auto flex justify-center items-center flex-col gap-2">
                ...
                <?php foreach ($products as $product): ?>
                    <tr class="text-gray-700 border-b-gray-300 border-2">
                        ...
                        <td class="flex justify-around items-center">
                            <a href="edit_product.php?id=<?= $product["product_id"]; ?>" class=" btn btn-info"><svg
